      ...
      >
        ...
        >
          ...
          <button
            ...
            title={`${t('layout.sidebar.collapseSidebar')} (${formatShortcut('B')})`}
          >
            <PanelLeft className="size-3.5" />
          </button>

          <div className="flex-1" />
          <div className="flex" role="tablist" aria-label={t('layout.sidebar.sidebarView')}>
            <button
              type="button"
              role="tab"
