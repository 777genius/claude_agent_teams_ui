      ...
      <div className="flex flex-1 items-center justify-center bg-claude-dark-bg">
        <div className="p-8 text-center">
          ...
          <h3 className="mb-2 text-lg font-medium text-claude-dark-text">
            {t('layout.sessionTabContent.failedToLoadSession')}
          </h3>
      ...
      <div className="flex flex-1 items-center justify-center bg-claude-dark-bg">
        <div className="text-center">
          ...
          <p className="text-sm text-claude-dark-text-secondary">
            {t('layout.sessionTabContent.loadingSession')}
          </p>
        </div>
      </div>
    );
