...
export const MoreMenu = ({
  ...
  const topItems: MenuItem[] = [
    {
      id: 'search',
      label: t('layout.moreMenu.search'),
      icon: Search,
    ...
    {
      id: 'schedules',
      label: t('layout.moreMenu.schedules'),
      icon: Calendar,
      onClick: () => {
        openSchedulesTab();
        setIsOpen(false);
  ...
  const sessionItems: MenuItem[] = isSessionWithData
    ? [
        {
          id: 'export-md',
          label: t('layout.moreMenu.exportMarkdown'),
          icon: FileText,
          shortcut: '.md',
        ...
        {
          id: 'export-json',
          label: t('layout.moreMenu.exportJson'),
          icon: Braces,
          shortcut: '.json',
        ...
        {
          id: 'export-txt',
          label: t('layout.moreMenu.exportPlainText'),
          icon: Type,
          shortcut: '.txt',
        ...
        {
          id: 'analyze',
          label: t('layout.moreMenu.analyzeSession'),
          icon: Activity,
          onClick: () => {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        title={t('layout.moreMenu.moreActions')}
      >
