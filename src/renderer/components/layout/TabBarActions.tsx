  ...
  return (
    ...
    >
          ...
          <TooltipTrigger asChild>
            ...
            >
              {updateStatus === 'downloaded'
                ? t('layout.tabBarActions.restartToUpdate')
                : t('layout.tabBarActions.updateApp')}
            </button>
          </TooltipTrigger>
          <TooltipContent side="bottom">
            {updateStatus === 'downloaded'
              ? t('layout.tabBarActions.updateDownloadedRestart')
              : t('layout.tabBarActions.newVersionAvailable')}
          </TooltipContent>
        </Tooltip>
      )}
      ...
      <button
        ...
        title={t('layout.tabBarActions.notifications')}
      >
      ...
      <button
        ...
        title={t('layout.tabBarActions.teams')}
      >
      ...
      <button
        ...
        title={t('layout.tabBarActions.extensions')}
      >
      ...
      <button
        ...
        title={t('layout.tabBarActions.github')}
      >
      ...
      <button
        ...
        title={t('layout.tabBarActions.settings')}
      >
      ...
      {sidebarCollapsed && (
        <button
          ...
          title={t('layout.tabBarActions.expandSidebar')}
        >
