...
export const ProjectPathSelector = ({
  ...
  return (
    <div className="space-y-1.5">
      <Label>{t('dialogs.projectPath.label')}</Label>
      <div className="space-y-2">
        <div className="flex flex-col gap-2 md:flex-row md:items-start">
          <div className="inline-flex shrink-0 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] p-0.5">
            ...
            >
              {t('dialogs.projectPath.fromProjectList')}
            </button>
            <button
              type="button"
              className={cn(
            ...
            >
              {t('dialogs.projectPath.customPath')}
            </button>
          </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    value={customCwd}
                    aria-label={t('dialogs.projectPath.ariaLabel')}
                    onChange={(event) => onCustomCwdChange(event.target.value)}
                    placeholder={t('dialogs.projectPath.placeholder')}
                  />
                  <Button
                    variant="outline"
                    size="sm"
