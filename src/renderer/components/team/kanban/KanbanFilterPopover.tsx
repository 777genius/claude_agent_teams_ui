...
/** Column definitions with i18n keys and accent colors for filter UI. */
  ...
  return (
    <Popover>
      <Tooltip>
        <TooltipTrigger asChild>
          <PopoverTrigger asChild>
            <Button
              ...
              aria-label={t('kanban.filter.filterTasks')}
            >
              <Filter size={14} />
              {activeCount > 0 && (
        ...
        <TooltipContent side="bottom">{t('kanban.filter.filterTasks')}</TooltipContent>
      </Tooltip>
